...
mod tests {
    #[test]
    fn matches() { assert!("file.txt".ends_with(".txt")); }

    #[test]
    fn no_match() { assert!(!"file.txt".ends_with(".rs")); }

    #[test]
    fn empty_suffix() { assert!("hello".ends_with("")); }

    #[test]
    fn full_string() { assert!("hello".ends_with("hello")); }
}
