...
mod tests {
    #[test]
    fn basic() { assert_eq!("ab".repeat(3), "ababab"); }

    #[test]
    fn zero() { assert_eq!("ab".repeat(0), ""); }

    #[test]
    fn one() { assert_eq!("hello".repeat(1), "hello"); }

    #[test]
    fn empty() { assert_eq!("".repeat(5), ""); }
}
