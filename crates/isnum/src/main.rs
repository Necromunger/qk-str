...
mod tests {
    #[test]
    fn integer() { assert!("42".parse::<f64>().is_ok()); }

    #[test]
    fn float() { assert!("42.5".parse::<f64>().is_ok()); }

    #[test]
    fn negative() { assert!("-3.14".parse::<f64>().is_ok()); }

    #[test]
    fn not_number() { assert!("hello".parse::<f64>().is_err()); }

    #[test]
    fn empty_string() { assert!("".parse::<f64>().is_err()); }
}
