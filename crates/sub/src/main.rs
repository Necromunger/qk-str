...
mod tests {
    ...
    #[test]
    fn basic() { assert_eq!(substring("hello world", 6, 5), "world"); }

    #[test]
    fn from_start() { assert_eq!(substring("hello", 0, 3), "hel"); }

    #[test]
    fn beyond_length() { assert_eq!(substring("hi", 0, 100), "hi"); }

    #[test]
    fn unicode() { assert_eq!(substring("café", 0, 4), "café"); }

    #[test]
    fn offset_beyond() { assert_eq!(substring("hi", 10, 5), ""); }
}
